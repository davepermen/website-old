...
namespace EvState.ScheduledTasks
{
    public class PollEvState : IScheduledTask
    {
        ...
        public PollEvState(IHttpClientFactory httpClientFactory, EvState evState, IConfiguration configuration)
        {
            ...
            httpClient.DefaultRequestHeaders.Add("X-Tesla-User-Agent", "TeslaApp/3.4.4-350/fad4a582e/android/9.0.0");
        ...
        public async Task InvokeAsync()
        {
            ...
            foreach (var vehicle in vehicles.response)
            {
                ...
                {
                    evState.Name = vehicle.display_name;

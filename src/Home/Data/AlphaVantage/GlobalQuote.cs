...
namespace Home.Data.AlphaVantage
{
    public class GlobalQuote
    {
        ...
        [JsonPropertyName("07. latest trading day")] public string LatestTradingDay { get; set; } = "";
        [JsonPropertyName("08. previous close")] public string PreviousClose { get; set; } = "";
        [JsonPropertyName("09. change")] public string Change { get; set; } = "";
        [JsonPropertyName("10. change percent")] public string ChangePercent { get; set; } = "";
    }
}
